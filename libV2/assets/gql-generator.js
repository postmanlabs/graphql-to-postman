 ...
 *
 * @param gqlSchema - String of GraphQL Schema in SDL format
...
function generateQuery (
  ...
  if (curName === 'canReceiveOrganizationEmailsWhenNotificationsRestricted') {
    // console.log('Yes');
  }
  ...
  if (curType.getFields) {
    ...
    childQuery = childKeys
      ...
      .map((cur) => {
        return generateQuery(gqlSchema, cur, curType, options, argumentsDict, duplicateArgCounts,
        ...
        const valueTypeName = types[i],
          ...
          unionChildQuery = Object.keys(valueType.getFields())
            ...
            .map((cur) => {
              ...
              return generateQuery(gqlSchema, cur, valueType, options, argumentsDict, duplicateArgCounts,
