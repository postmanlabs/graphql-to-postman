var schemaToQuery = require('./assets/gql-generator').schemaToQuery,
  converter,
  { convertV2 } = require('../libV2/convert'),
  util = require('./util'),
...
converter = {
  ...
  /** Converts GraphQL schema into a Postman Collection.
   * This is new interface aiming to improve the performance problems existing with older interface.
   *
   * @param {Object} input Input
   * @param {String} input.type Type of input 'file' / 'string'
   * @param {String} input.data Input data
   ...
   * @param {Function} callback Callback
   */
  convertV2: function (input, options, callback) {
    var data;
    ...
    return convertV2(data, options, callback);
  }
};
